...
let minuteElement = document.querySelector("#mins");
let secondElement = document.querySelector("#secs");
let millisecondElement = document.querySelector("#mills");
...
// THIS IS A COUNTER CODE TO PLAY AROUND WITH

// let counter = 0;
// let btnStart = document.getElementById("start").onclick = count;
// function count(){
//     document.getElementById("hours").innerHTML=counter;
//     counter++
// }
